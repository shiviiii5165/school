  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-text-secondary mt-1">Manage system configuration and preferences</p>
      </div>
      ...
      <div className="bg-surface border border-border rounded-xl p-12 text-center">
        ...
        <p className="text-sm text-text-secondary">System settings will be available in the next release.</p>
      </div>
    </div>
  );
}
