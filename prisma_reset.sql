...
DROP TABLE IF EXISTS "AttendanceSummary" CASCADE;
DROP TABLE IF EXISTS "DailyAttendanceLog" CASCADE;
DROP TABLE IF EXISTS "Assignment" CASCADE;
DROP TABLE IF EXISTS "Submission" CASCADE;
DROP TABLE IF EXISTS "Result" CASCADE;
DROP TABLE IF EXISTS "FeeRecord" CASCADE;
DROP TABLE IF EXISTS "DisciplineReport" CASCADE;
DROP TABLE IF EXISTS "Notice" CASCADE;
DROP TABLE IF EXISTS "Leave" CASCADE;
DROP TABLE IF EXISTS "Notification" CASCADE;
DROP TABLE IF EXISTS "TimetablePeriod" CASCADE;
DROP TABLE IF EXISTS "SystemSettings" CASCADE;
DROP TABLE IF EXISTS "FeeType" CASCADE;
